 ...
 * solo los datos necesarios para actualizar una acción.
 */
@Schema(description = "Datos para actualizar una acción existente")
public record AccionUpdateRequest(
        
        @Schema(description = "Nombre de la acción", 
                example = "Crear Usuario Actualizado",
        ...
        @Schema(description = "Descripción detallada de la acción", 
                example = "Permite crear nuevos usuarios en el sistema con validaciones adicionales")
